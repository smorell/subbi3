	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li>{{HTML::link('office/subbi','Subbis')}} <span class="divider">/</span></li>
	...
	<div class="row">
		<div class="span12">
			<h5>Subbi bearbeiten</h5>
				...
				{{Form::open('office/subbi/'.$subbi->id, 'PUT', array('class' => 'form-horizontal', 'id' => ''))}}
									...
									<div class="row">
										<div class="span6">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" placeholder="Vorname" class="span4" name="first_name" value="{{$subbi->first_name}}">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" placeholder="Nachname" class="span4" name="last_name" value="{{$subbi->last_name}}">
												</div>
								            </div>
								            
								            <div class="control-group">
												<label class="control-label" for="address1">Straße / HNr.</label>
												<div class="controls">
													<input type="text" id="" placeholder="Straße" class="span4" name="address1" value="{{$subbi->address1}}">
												</div>
								            </div>
								            
								            <div class="control-group">
												<label class="control-label" for="zipcode">PLZ / Ort</label>
												<div class="controls controls-row">
													<input type="text" id="zipcode" placeholder="PLZ" class="span1" name="zipcode" value="{{$subbi->zipcode}}">
													<input type="text" id="city" placeholder="Ort" class="span3 pull-right" name="city" value="{{$subbi->city}}">
												</div>
								            </div>
										...
										<div class="span5">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" placeholder="000 / 00 00 0000" name="phone" value="{{$subbi->phone}}">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" placeholder="name@domain.de" name="email" value="{{$subbi->email}}">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<div class="input-append date" id="dp1" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
													  <input class="span2" size="16" type="text" name="dob" value="{{date('d.m.Y',strtotime($subbi->dob))}}">
													  ...
													  <tbody>
													  	<tr>
													  		<td>
																  ...
																  <input class="span2" size="16" type="text"  name="hist_1_from" value="{{date('d.m.Y',strtotime($subbi->hist_1_from))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<div class="input-append date" id="b1" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text" name="hist_1_to" value="{{date('d.m.Y',strtotime($subbi->hist_1_to))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<textarea rows="2" class="span4 input-block-level" name="hist_1_notes">{{$subbi->hist_1_notes}}</textarea>
													  		</td>
													  	</tr>
													  	<tr>
													  		<td>
													  			<div class="input-append date" id="v2" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_2_from" value="{{date('d.m.Y',strtotime($subbi->hist_2_from))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<div class="input-append date" id="b2" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_2_to" value="{{date('d.m.Y',strtotime($subbi->hist_2_to))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<textarea rows="2" class="span4 input-block-level" name="hist_2_notes">{{$subbi->hist_2_notes}}</textarea>
													  		</td>
													  	</tr>
													  	<tr>
													  		<td>
													  			<div class="input-append date" id="v3" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_3_from" value="{{date('d.m.Y',strtotime($subbi->hist_3_from))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  		...
													  		<td>
													  			<textarea rows="2" class="span4 input-block-level" name="hist_3_notes">{{$subbi->hist_3_notes}}</textarea>
													  		</td>
													  	</tr>
													  	<tr>
													  		<td>
													  			<div class="input-append date" id="v4" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_4_from" value="{{date('d.m.Y',strtotime($subbi->hist_4_from))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<div class="input-append date" id="b4" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_4_to" value="{{date('d.m.Y',strtotime($subbi->hist_4_to))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<textarea rows="2" class="span4 input-block-level" name="hist_4_notes">{{$subbi->hist_4_notes}}</textarea>
													  		</td>
													  	</tr>
													  	<tr>
													  		<td>
													  			<div class="input-append date" id="v4" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_5_from" value="{{date('d.m.Y',strtotime($subbi->hist_5_from))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<div class="input-append date" id="b4" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
																  <input class="span2" size="16" type="text"  name="hist_5_to" value="{{date('d.m.Y',strtotime($subbi->hist_5_to))}}">
																  <span class="add-on"><i class="icon-calendar"></i></span>
																</div>
													  		</td>
													  		<td>
													  			<textarea rows="2" class="span4 input-block-level" name="hist_5_notes">{{$subbi->hist_5_notes}}</textarea>
													  		</td>
													  	</tr>
									...
									<div class="row">
										...
										<div class="span5">
											...
											<div class="control-group">
												...
												<div class="controls">
													<select class="span4" name="promoter_id">
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<select class="span4" name="campaign_id">
